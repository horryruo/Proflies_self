...
if ($request && $request.method != 'OPTIONS' && $request.url.match(/\_\-\_followsuper/) && $request.url.match(/cardlist/)){
...
if ($request && $request.method != 'OPTIONS' && $request.url.match(/\_\-\_followsuper/) && $request.url.match(/active\_checkin/)){
